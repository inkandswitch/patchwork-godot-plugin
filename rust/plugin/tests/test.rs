...
fn get_platform_example_source() -> String {
    r#"[gd_scene load_steps=6 format=3 uid="uid://coq6d3u6wnvs2"]
...
#[test]
#[ignore]
fn end_to_end_platform_example() {
    let source = get_platform_example_source();
